...
export default function ResetPassword() {
    return (
        <div className='container'>
            ...
            <img className='verticalImage' src={ResetPasswordImage1} />
            <h3>2 - Preencha as informações</h3>
            <p>Preencha corretamente o "E-mail" cadastrado no aplicativo.</p>
            <img className='verticalImage' src={ResetPasswordImage2} />
            ...
            <img className='verticalImage' src={ResetPasswordImage3} />
            <h3>4 - Receber E-mail</h3>
            <p>Instruções para redefinição de senha serão recebidas no e-mail informado.</p>
            <img className='horizontalImage' src={ResetPasswordImage4} />
            ...
            <img className='horizontalImage' src={ResetPasswordImage5} />
            ...
            <img className='horizontalImage' src={ResetPasswordImage6} />
            ...
            <img className='horizontalImage' src={ResetPasswordImage7} />
        </div>
    )
}
